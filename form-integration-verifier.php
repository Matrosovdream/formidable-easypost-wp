    ...
    add_action( 'wp_footer', function () {
        ...
        (function($){
            $(function(){
                ...
                // === Your mapping stays the same (DON'T change zipcode field reference here) ===
                var ADDRESSES = {
                    3: { fields: { street1: 37, city: 39, state: 40, zipcode: 41 } },
                };
                ...
                $(document).on('click', '#epvContinue', function(){
                    ...
                    if (choice === 'normalized' && lastResult && lastResult.normalized && lastResult.fieldsMap) {
                        ...
                        // Prefer components.* when available for city/state,
                        // and set zipcode from normalized.full_zipcode per your requirement.
